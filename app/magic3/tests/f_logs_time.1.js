            ...
            if (resultKey === null) {
                ...
                switch (this.view.focus) {
                    ...
                    case "hours":
                        ...
                        if (this.view.day + 1 in this.cache.data.dayHours) {

                            this.view.day++;
                            this.view.data = this.cache.data.dayHours[this.view.day];

                            const keysNext = Object.keys(this.view.data).map(Number);
                            const firstKeyNext = keysNext[0];

                            //this.cache.pos = firstKeyNext;
                            this.display_date();

                            this.graph(this.view.data, firstKeyNext, 0);

                            resultKey = firstKeyNext;
                        }
                        else
                    ...
                    case "days":
                        ...
                        if (this.view.month + 2 in this.cache.data.months) {
                    ...
                    case "months":
                        ...
                        if (this.view.year + 1 in this.cache.data.years) {
                            this.view.year++;
                            this.view.data = this.cache.data.years[this.view.year];
            ...
            if (resultKey === null) {
                ...
                switch (this.view.focus) {
                    ...
                    case "hours":
                       ...
                       // if   = keys[keys.length - 1];
                        ...
                        if (this.view.day -1 in this.cache.data.dayHours) {
                            ...
                            this.view.day--;
                            this.view.data = this.cache.data.dayHours[this.view.day];
                            if (this.dbg) console.log("case hours: this.view.day,this.view.data:",this.view.day,this.view.data );

                            const keysPrev = Object.keys(this.view.data).map(Number);
                            const LastKeyPrev = keysPrev[keysPrev.length - 1];

                            this.display_date();
                            this.graph(this.view.data, LastKeyPrev, 0);

                            resultKey = LastKeyPrev;
                        }
                        else
                    ...
                    case "days":
                        ...
                        if (this.view.month in this.cache.data.months) {
                            ...
                            resultKey = firstKey;
                        //resultKey = loopMode ? lastKey : firstKey;
                        break;

                    case "months":
                        if (this.dbg) console.log("case months:his.view.focus,this.view:", this.view.focus, this.view);
